...
import { getHeaderTopPosition, getMobileSafeAreaMargin, mainColor } from '../api';
import LogoWord from '../../public/logo/logo_word.png';

export const Header = () => {
  const statusBarHeight = getMobileSafeAreaMargin();
  ...
  return (
    ...
    >
      <Link to="/">
        <Image filter="invert(1)" h="7vh" mt="1.2vh" src={LogoWord} />
      </Link>
    </Box>
  );
};
