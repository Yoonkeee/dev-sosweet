...
const AddPay = ({ isOpen, onClose, initName = '' }) => {
  const {
    register,
    reset,
    handleSubmit,
  ...
  return (
    ...
    >
      ...
      <ModalContent>
        <ModalHeader>
          <HStack>
            <Flex justifyContent={'center'} alignItems={'center'} aspectRatio={1} maxH="70px">
        ...
        <HStack alignContent="center" alignItems="center" justifyContent="center" mb="2vh" w="100%">
          <IconButton
            ...
            w="6%"
          />
          <Text fontSize="2xl" fontWeight="semibold" id="formattedNowDate" textAlign="center">
            {formattedDate}
          </Text>
          <IconButton
            _hover={{
